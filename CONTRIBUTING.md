...
Thank you for your interest in contributing to confide.

## Current status

> [!NOTE]
> confide is in early development and is not yet accepting pull requests.
...
- **Report bugs** - If you encounter issues while using confide, please open a GitHub issue with a minimal reproducible example
- **Request features** - Have an idea that would make confide more useful? Open an issue to start a discussion
- **Improve documentation** - Found a typo or unclear explanation? Documentation improvements are welcome
- **Share feedback** - Open an issue or discussion about how you're using confide and what could be better
